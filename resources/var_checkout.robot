...
${locatorB_checkout_search_btn}    dom:document.querySelectorAll("a[alt='sousuo1']")[0]    #.checkout搜索按钮
${locatorB_checkout_user_name}    dom:document.querySelectorAll("div[alt='logo']")[0]    #.checkout顶部店铺名
${locatorB_checkout_card_img_btn}    dom:document.querySelectorAll("a[alt='bag']")[0]    #.checkout购物车图标按钮
