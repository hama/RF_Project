...
${locatorB_subtractionsMain_text_firstActivityID}    dom:document.querySelectorAll('[class="ant-table-tbody"] tr td:nth-child(1)')    # 满减活动 - 第一个活动 - 活动编号
${locatorB_subtractionsMain_text_firstActivityName}    dom:document.querySelectorAll('[class="ant-table-tbody"] tr td:nth-child(2)')    # 满减活动 - 第一个活动 - 活动名称
${locatorB_subtractionsMain_text_firstActivityTime}    dom:document.querySelectorAll('[class="ant-table-tbody"] tr td:nth-child(3)')    # 满减活动 - 第一个活动 - 活动时间
${locatorB_subtractionsMain_text_firstActivityCode}    dom:document.querySelectorAll('[class="ant-table-tbody"] tr td:nth-child(4)')    # 满减活动 - 第一个活动 - 优惠项
${locatorB_subtractionsMain_text_firstActivityRange}    dom:document.querySelectorAll('[class="ant-table-tbody"] tr td:nth-child(5)')    # 满减活动 - 第一个活动 - 适用商品
${locatorB_subtractionsMain_text_firstActivityStatus}    dom:document.querySelectorAll('[class="ant-table-tbody"] tr td:nth-child(6)')    # 满减活动 - 第一个活动 - 活动状态
