...
${locatorB_productsNew_iframe_desc}    dom:document.querySelectorAll('[id="product.description_ifr"]')[0]    # 添加商品页面-描述iframe
${locatorB_productsNew_input_desc}    dom:document.querySelectorAll('[id="tinymce"]')[0]    # 添加商品页面-描述
...
${locatorB_productsNew_text_seouUrl}    dom:document.querySelectorAll('[class*="seo_url"]')[0]    # seo链接展示
...
${locatorB_productsNew_select_weightUnit}    dom:document.querySelectorAll('[class="ant-select ant-select-enabled"]')[0]    # 添加商品页面-重量单位
