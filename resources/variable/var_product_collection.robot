...
${locatorB_productsCollection_input_search}    dom:document.querySelectorAll('input[class="ant-input"]')    #商品专辑页-搜索输入框
...
${locatorB_productsCollection_button_add}    css:.ant-btn.large_btn___3RbRK.text_button___2j2cR   #商品专辑-新增专辑按钮
...
${locatorB_productsCollection_text_collectiontbody}    dom:document.querySelectorAll('tbody[class="ant-table-tbody"]')    # 商品专辑-列表内容
${locatorB_productsCollection_text_collectiontbody_td}    css:tbody[class="ant-table-tbody"] tr td:nth-child(5)    # 商品专辑页面，列表所有名称
