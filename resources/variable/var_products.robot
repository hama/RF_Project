...
${locatorB_productsMgmt_text_firstProductName}    dom:document.querySelectorAll('tbody tr td span')[4]     #列表第一个商品的名字
...
${locatorB_productsMgmt_image_center}    dom:document.querySelectorAll('img[class="center___1nHSZ"]')[0]    #商品列表的图片
