...
${locatorB_taxPrice_i_setUp}       dom:document.querySelectorAll('.djfont')[0]      #.税费设置的第一个国家，设置操作

#.税费设置 center
${locatorB_taxPrice_set_taxes}     dom:document.querySelectorAll('.ant-inpu)[0]     #.税费设置-国家税率设置input

${locatorB_taxPrice_button_submit}      dom:document.querySelectorAll('.ant-btn)[0]     #.税费设置-确定提交按钮
#   button
