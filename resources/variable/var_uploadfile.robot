...
${locatorB_uploadFile_nav_shippingImg}    dom:document.querySelectorAll('.ant-tabs-tab')[0]
${locatorB_uploadFile_img_shippingImg}    dom:document.querySelectorAll('[class*="ant-table-row"] [class*="center"]')[0]

${locatorB_uploadFile_add_btn}    dom:document.querySelectorAll('input[type="file"]')[0]    #.文件管理- 上传文件
${locatorB_uploadFile_del_img}    dom:document.querySelectorAll('.icon_custom___3gJ6J')[0]    #.文件管理- 删除按钮
${locatorB_uploadFile_upfile_txt}    dom:document.querySelectorAll('.ant-tabs-tab')[1]    #.文件管理- 上传文件 字体
