...
#.nva
${locatorB_uploadFile_nav_shippingImg}    dom:document.querySelectorAll('[class="ant-tabs-nav-scroll"] [class*="ant-tabs-tab"]')[0]     #.商品图
...
${locatorB_uploadFile_icon_delImg}    dom:document.querySelectorAll('[class*="icon_custom"]')   #.文件管理- 删除按钮
