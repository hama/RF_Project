...
docker run -d -v /dev/shm:/dev/shm -v /var/log:/var/log --name "$TIMESTAMP"_2  registry.shoplazza.com/library/uitest:v7 \
...
docker run -d -v /dev/shm:/dev/shm -v /var/log:/var/log --name "$TIMESTAMP"_3  registry.shoplazza.com/library/uitest:v7 \
...
docker run -d -v /dev/shm:/dev/shm -v /var/log:/var/log --name "$TIMESTAMP"_4  registry.shoplazza.com/library/uitest:v7 \
...
docker run -d -v /dev/shm:/dev/shm -v /var/log:/var/log --name "$TIMESTAMP"_5  registry.shoplazza.com/library/uitest:v7 \
...
docker run -d -v /dev/shm:/dev/shm -v /var/log:/var/log --name "$TIMESTAMP"_6  registry.shoplazza.com/library/uitest:v7 \
...
docker run -d -v /dev/shm:/dev/shm -v /var/log:/var/log --name "$TIMESTAMP"_7  registry.shoplazza.com/library/uitest:v7 \
...
docker run -d -v /dev/shm:/dev/shm -v /var/log:/var/log --name "$TIMESTAMP"_8  registry.shoplazza.com/library/uitest:v7 \
...
docker run -d -v /dev/shm:/dev/shm -v /var/log:/var/log --name "$TIMESTAMP"_9  registry.shoplazza.com/library/uitest:v7 \
...
docker run -d -v /dev/shm:/dev/shm -v /var/log:/var/log --name "$TIMESTAMP"_10  registry.shoplazza.com/library/uitest:v7 \
...
docker run -d -v /dev/shm:/dev/shm -v /var/log:/var/log --name "$TIMESTAMP"_11  registry.shoplazza.com/library/uitest:v7 \
...
docker run -d -v /dev/shm:/dev/shm -v /var/log:/var/log --name "$TIMESTAMP"_12  registry.shoplazza.com/library/uitest:v7 \
...
docker run -d -v /dev/shm:/dev/shm -v /var/log:/var/log --name "$TIMESTAMP"_13  registry.shoplazza.com/library/uitest:v7 \
