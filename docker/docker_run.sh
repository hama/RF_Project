...
do
	...
	docker run -d -v /dev/shm:/dev/shm -v /var/log:/var/log -v /opt:/opt --rm --name $DOCKER_LOG_FILE registry.shoplazza.com/library/uitest:v10 \
...
do
    ...
    then
        ...
        docker run -d -v /var/log:/var/log -v /opt:/opt --rm registry.shoplazza.com/library/uitest:v10 \
