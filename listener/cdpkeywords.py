...
class cdpkeywords():
    ...
    def get_decoded_request_data(self, request_data):
        ...
        for item_str in items_str_list:
            ...
            if map_str[0] == 'data':
                request_data_dict[map_str[0]] = json.loads(decode_base64(map_str[1].strip('%3D')))
            else:
...
if __name__ == '__main__':
    ...
    print json.dumps(cdp.assert_equal_values(decoded_request_data_list, raw_data))
