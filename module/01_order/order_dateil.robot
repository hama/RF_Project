...
order_detail_update_send_not
    ...
    ${input}    set variable    123456
    ${res}    execute javascript    return document.querySelectorAll(".ant-col-3 p")[1].innerHTML
    Run keyword If    '${res}'=='未发货'    Run keyword    click button    添加运单
    Run keyword If    '${res}'=='未发货'    Run keyword    page should contain button    dom:document.querySelectorAll("button")[4]
    Run keyword If    '${res}'=='未发货'    Run keyword    click button    dom:document.querySelectorAll("button")[4]
    Run keyword If    '${res}'=='未发货'    Run keyword    page should contain element    ${order_dateil_update_send}
    Run keyword If    '${res}'=='未发货'    Run keyword    Wait Until Element Is Visible    ${shipping_code}
...
order_detail_cancel_send
    ...
    Execute Javascript    return document.querySelectorAll(".icon_cancel___miRJp")[0].click()
    sleep    1
